<x-app-layout>
    <div class="p-4 sm:ml-64 mt-20 h-fit">
        <div class="block max-w-7xl bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-auto max-h-fit pb-96">
            ...
            <div class="grid grid-cols-2 gap-2 h-fit p-5 md:px-20">
                <a href="{{ route('pasien.ketentuan') }}">
                    <div class="max-w-lg bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative mt-40 h-full hover:border-2 hover:border-blue-600">
                        ...
                        <div class="p-5 text-center w-full relative top-[65%]">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">BPJS</h5>
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="max-w-lg bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative mt-40 h-full hover:border-2 hover:border-blue-600">
                        ...
                        <div class="p-5 text-center w-full relative top-[65%]">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">UMUM</h5>
                        </div>
                    </div>
                </a>
            </div>
