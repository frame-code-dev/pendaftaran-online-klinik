<x-guest-layout>
    <div class="py-4">
        <h4 class="font-bold text-3xl">Daftar Akun</h4>
        <hr>
    </div>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex-row items-center justify-center mt-4 w-full text-start">
            <div>
                <x-primary-button class="w-full items-center content-center">
                    {{ __('Register') }}
                </x-primary-button>
            </div>
