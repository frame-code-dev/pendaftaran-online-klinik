                                    ...
                                    <tr class="border">
                                        <td class="px-4 py-3">
                                            <div class="relative">
                                                ...
                                                <input value="{{ $item->senin }}" type="time" name="status_{{ $item->status }}_senin" id="status_{{ $item->status }}_senin" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                            </div>
                                        </td>
                                        <td class="px-4 py-3">
                                            <div class="relative">
                                                ...
                                                <input type="time" value="{{ $item->selasa }}" name="status_{{ $item->status }}_selasa" id="status_{{ $item->status }}_selasa" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                            </div>
                                        </td>
                                        <td class="px-4 py-3">
                                            <div class="relative">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="relative">
                                                ...
                                                <input type="time" value="{{ $item->kamis }}" name="status_{{ $item->status }}_kamis" id="status_{{ $item->status }}_kamis" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                            </div>
                                        </td>
                                        <td class="px-4 py-3">
                                            <div class="relative">
                                                ...
                                                <input type="time" value="{{ $item->jumaat }}" name="status_{{ $item->status }}_jumaat" id="status_{{ $item->status }}_jumaat" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                            </div>
                                        </td>
                                        <td class="px-4 py-3">
