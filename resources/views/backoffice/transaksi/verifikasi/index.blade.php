                        ...
                        @foreach ($data as $item)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    ...
                                    <a href="{{ route('verifikasi.update-manual',$item->id) }}" type="button" class="text-white bg-{{ $item->status_verifikasi == 'sudah-verifikasi' ? 'green' : 'gray' }}-{{ $item->status_verifikasi == 'sudah-verifikasi' ? '700' : '500' }}
