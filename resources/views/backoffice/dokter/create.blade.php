    ...
    <div class="p-4 sm:ml-64 pt-20 h-full">
        <section class="p-5 overflow-y-auto mt-5">
            ...
            <div class="card bg-white p-5 mt-4 border rounded-md w-full relative">
                <form action="{{ route('dokter.store') }}" method="POST" class="w-full mx-auto space-y-4" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <x-label-default for="" value="Nama Dokter">Nama Dokter</x-label-default>
                        <x-input-default name="name" type="text" value="{{ old('name') }}" placeholder="Masukkan Nama Dokter"></x-input-default>
                    </div>
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div>
                            <x-label-default for="" value="Tanggal Lahir">Tanggal Lahir</x-label-default>
                    ...
                    <div>
                        ...
                        <div class="flex items-center w-full">
                            <div class="relative w-1/2">
                                ...
                                <input type="time" name="dari" id="dari" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                            </div>
                            ...
                            <div class="relative w-1/2">
                                ...
                                <input type="time" name="sampai" id="sampai" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                            </div>
                        </div>
                    </div>
                    <div>
