        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <div class="w-full mx-auto" >
                    <form action="{{ route('dokter.update-status') }}" method="POST" class="w-full mx-auto" >
                    @csrf
                    <input type="text" name="id" id="id" class="id" hidden>
                    <h4 class="font-bold underline">Apakah anda yakin ingin mengubah status dokter ini?</h4>
                </div>
            </div>
            <!-- Modal footer -->
