        ...
        <section class="p-5 overflow-y-auto mt-5">
            ...
            <div class="card bg-white p-5 mt-4 border rounded-md w-full relative">
                <div class="flex items-start content-start gap-4">
                    <div class="w-1/2">
                        <img class="rounded-md w-96 h-96 mx-auto" src="{{ $poliklinik->gambar != null ? asset('storage/poliklinik/'.$poliklinik->gambar) : 'https://flowbite.com/docs/images/examples/image-2@2x.jpg' }}" alt="image description">
                    </div>
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <tbody class="border p-4 w-full">
                                <tr class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <td width="20%" class="p-4">Nama Poliklinik</td>
                                    <td width="1%">:</td>
                                    <td class="font-bold">{{ ucwords($poliklinik->name) }}</td>
                                </tr>
                                <tr class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <td width="20%" class="p-4">Keterangan</td>
                                    <td width="1%">:</td>
                                    <td class="font-bold">{{ $poliklinik->keterangan }}</td>
                                </tr>
                                ...
                                <tr class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    ...
                                    <td width="1%">:</td>
                                    <td class="font-bold">
                                        {{ \Carbon\Carbon::parse($poliklinik->created_at)->translatedFormat('d F Y H:i:s') }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
